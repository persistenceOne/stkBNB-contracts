...
if (currenthours == InitiateDelegation_start_hour  && currentmins > InitiateDelegation_start_min && currentmins < InitiateDelegation_end_min) 
...
{ 
  ...
  initiateDelegationEvent.forEach((delegateEvent) => {     
    ...
    InitiateDelegationEventFlag=true;  
      ...
      if(InitiateDelegationEventFlag==false && currentmins >= (InitiateDelegation_end_min - 1) && currentmins < InitiateDelegation_end_min)
...
if (currenthours == EpochUpdate_start_hour  && currentmins > EpochUpdate_start_min && currentmins < EpochUpdate_end_min) 
{ 
  const epochUpdateEvent = txEvent.filterLog(
    BOT_EPOCH_UPDATE_EVENT,
    STAKEPOOL_ADDRESS
  );
  ...
  epochUpdateEvent.forEach((epochupdateEvent) => {     
    ...
    EpochUpdateEventFlag=true; 
      ...
      if(EpochUpdateEventFlag==false && currentmins >= (EpochUpdate_end_min - 1) && currentmins < EpochUpdate_end_min){      
...
if (currentday==UnbondingInitiated_day_of_week && currenthours == UnbondingInitiated_start_hour  && currentmins > UnbondingInitiated_start_min && currentmins < UnbondingInitiated_end_min) 
{ 
  ...
  unbondingInitiatedEvent.forEach((unbondinginitiatedEvent) => {     
    ...
    UnbondingInitiatedEventFlag=true;    
      ...
      if(UnbondingInitiatedEventFlag==false && currentmins >= (UnbondingInitiated_end_min-1) && currentmins <UnbondingInitiated_end_min){
...
if (currentday==UnbondingFinished_day_of_week && currenthours == UnbondingFinished_start_hour  && currentmins > UnbondingFinished_start_min && currentmins < UnbondingFinished_end_min) 
{ 
  const initiateDelegationEvent = txEvent.filterLog(
  ...
  initiateDelegationEvent.forEach((unbondingfinishedEvent) => {     
    ...
    UnbondingFinishedEventFlag=true;   
      ...
      if(UnbondingFinishedEventFlag==false && currentmins >= (UnbondingFinished_end_min - 1) && currentmins < UnbondingFinished_end_min){
