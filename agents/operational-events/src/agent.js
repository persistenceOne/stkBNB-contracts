...
const { getAbi, extractEventArgs, parseExpression, checkLogAgainstExpression } = require('./utils');
    ...
    return async function handleTransaction(txEvent) {
        ...
        contracts.forEach(contract => {
            ...
            eventInfo.forEach(event => {
                const { name, signature, expression, expressionObject, type, severity } = event;
