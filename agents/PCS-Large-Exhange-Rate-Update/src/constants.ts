...
const ER_THRESHOLD = Number("0"); // percent change in exchange rate threshold from previous exchange rate.
...
export { SWAP_EVENT, ER_THRESHOLD, ERC20ABI, PANCAKE_PAIR_ABI, PANCAKE_FACTORY_ADDRESS, INIT_CODE_PAIR_HASH, STKBNB_POOL_ADDRESS ,STKBNB_TOKEN_ADDRESS, WBNB_TOKEN_ADDRESS };
